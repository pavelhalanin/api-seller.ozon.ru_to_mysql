...
class SaveJson_v1_delivery_method_list {
    static function main() {
        global $HOME;

        $data = SaveJson_v1_delivery_method_list::getSomeExample();
        ...
        $FILE_PATH = "$folder/v1_delivery_method_list.json";
    ...
    static function getSomeExample() {
        return SaveJson_v1_delivery_method_list::fetchJson([
            'limit' => 1000,
            'offset' => 0,
        ]);
    }
